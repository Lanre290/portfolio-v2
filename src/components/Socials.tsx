...
const Socials = () => {
    return (
        ...
        <div className="flex flex-row gap-2 md:gap-x-4 flex-wrap px-2 justify-center">
            ...
            <a href='https://www.linkedin.com/in/ashiru-sheriffdeen-olanrewaju-219725223/' target='_blank' className="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center text-xl border border-primary-color rounded-full primary-color hover-bg-primary-color socials hover:text-gray-50">
            <BsLinkedin className="text-xl md:text-2xl"></BsLinkedin>
            </a>
            <a href='https://www.instagram.com/ashiru._olanrewaju/' target='_blank' className="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center text-xl border border-primary-color rounded-full primary-color hover-bg-primary-color socials hover:text-gray-50">
